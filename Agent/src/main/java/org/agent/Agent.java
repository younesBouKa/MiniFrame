...
import org.agent.transformers.ClassLogger;
import org.agent.transformers.ObjectLifeCycleInterceptor;
...
public class Agent {
    ...
    public static File searchForToolsJarFile(){
        URL resource = Agent.class.getResource("/tools.jar");
        if(resource==null){
    ...
    public static void premain(String args, Instrumentation instrumentation){
        logger.debug("Hello from 'premain' in Agent with args: "+args);
    ...
    public static void agentmain(String args, Instrumentation instrumentation) {
        logger.debug("Hello from 'agentmain' in Agent with args: "+args);
        globalInstrumentation = instrumentation;
        try {
    ...
    public static long getObjectSize(Object obj) throws Exception {
        if(globalInstrumentation==null)
            throw new Exception("Agent no initialized");
    ...
    public static void process(String typeMethod, String args, Instrumentation instrumentation){
        ...
        logger.debug("Hello from '"+typeMethod+"' in Agent with params: "+params);
